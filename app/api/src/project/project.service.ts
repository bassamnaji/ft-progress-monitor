...
export class ProjectService {
  ...
  async saveProjects(intraUser: Me, createdUser: User): Promise<ProjectInfoResponseDto[]> {
    if (intraUser.projects_users === undefined || intraUser.projects_users.length == 0)
      return null;
