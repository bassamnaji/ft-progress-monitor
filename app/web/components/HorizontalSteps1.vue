  ...
  >
    <ol class="grid grid-cols-3 text-sm font-medium text-gray-500">
      <li class="relative text-left text-blue-600">
        <span
          class="absolute left-0 -bottom-[1.75rem] rounded-full bg-blue-600 text-white"
        >
          <svg
            class="h-5 w-5"
      ...
      <li class="relative text-center text-blue-600">
        <span
          class="absolute left-1/2 -bottom-[1.75rem] -translate-x-1/2 rounded-full bg-blue-600 text-white"
        >
          <svg
            class="h-5 w-5"
            xmlns="http://www.w3.org/2000/svg"
      ...
      <li class="relative text-right">
        ...
        <svg
          class="ml-auto h-6 w-6 sm:hidden"
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
          viewBox="0 0 24 24"
          stroke="currentColor"
